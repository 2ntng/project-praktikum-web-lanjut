                ...
                <div class="content-wrapper">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Flexible Neon EL Wire LED 2 meter no sirip ice blue 12V - 24V inverter</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-5 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="my-3 mx-1">Flexible Neon EL Wire LED 2 meter no sirip ice blue 12V - 24V inverter</h4>
                                    <hr>
                                    <h2 class="my-3 mx-1">Rp 10.000,00</h2>
