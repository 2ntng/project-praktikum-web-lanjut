        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col ">
                        <div align="right">
                            <button type="button" class="btn btn-outline-info btn-fw" disabled><b>New Order</b></button>
                        </div>
                    </div>
                </div>
                <!-- mulai daftar barang -->
                ...
                <div class="row">
                    ...
                    <div class="col ">
                        <div align="right">
                            <a href="/sendOrder">
                                <button type="button" class="btn btn-success btn-rounded btn-fw"><b>Confirm</b></button>
                            </a>
                        </div>
                    </div>
                </div>
